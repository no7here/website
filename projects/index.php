...
<html lang="en" class="h-100">
    ...
    <body class="d-flex h-100 text-white bg-black">
        <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            ...
            <div style="animation-delay: 1.5s;" class="slide-down">
            ...
            <main class="px-3"><br>
                <h1 class="slide-up">Projects.</h1>
                <p style="animation-delay: 0.25s;" class="slide-up lead">A list of some projects I'm currently working on.</p>
                <div style="animation-delay: .5s;" class="slide-up box">
                    <img src="/assets/icon/globe.png" style="width:100px;height:100px;padding:25px;">
                    <h1>Website</h1>
                    <p>This website! Built using PHP, HTML, CSS and JS.</p>
                </div>
                <div style="animation-delay: .75s;" class="slide-up box">
                    <img src="/assets/icon/spotify.png" style="width:100px;height:100px;padding:25px;">
                    <h1>Spotify Transfer</h1>
                    <p>A transfer tool to move your music across to a new account.</p>
                </div>
                <a href="https://www.guilded.gg/b/acd5fc8c-4272-48d0-b78b-da1fecb1bab5" target="_blank">
                    <div style="animation-delay: 1s;" class="slide-up box">
                        <img src="/assets/icon/guilded.png" style="width:100px;height:100px;padding:5px;">
                        <h1>Rayz</h1>
                        <p>A multipurpose Guilded bot with a focus on moderation.</p>
                    </div>
                </a>
                <a href="https://github.com/no-there" target="_blank">
                    <div style="animation-delay: 1.25s;" class="slide-up box">
                        <img src="/assets/icon/github.png" style="width:100px;height:100px;padding:25px;">
                        <h1>Other Projects</h1>
                        <p>Click to open GitHub to view some of my other projects.</p>
                    </div>
                </a><br>
            </main>
            <footer class="mt-auto">
                <p style="animation-delay: 1.5s;" class="text-center slide-up text-white-50">not here | Copyright &copy; <?php echo date("Y") ?> all rights reserved<?php if (date("d") == 4 and date("m") == 5) {} else if (date("d") == 5 and date("m") == 11) {} else if (date("d") == 31 and date("m") == 10) {} else if (date("d") == 11 and date("m") == 6) {} else { ?> | watch the video <a style="text-decoration: none;" class="text-white-50 link-underline" href="<?php if (date("d") == 1 and date("m") == 4) { echo "https://www.youtube.com/watch?v=dQw4w9WgXcQ"; } else if (date("d") == 4 and date("m") == 7) { echo "https://www.youtube.com/watch?v=MAnRzeTlMGc"; } else { echo "https://www.youtube.com/watch?v=TUvcVBUv0rg"; } ?>" target="_blank">here</a><?php } ?></p>
            </footer>
